...
func confirmPayload(ctx context.Context, log log.Logger, eng ExecEngine, fc eth.ForkchoiceState, buildingOnto eth.BlockID, id eth.PayloadID, updateSafe, localOnly bool) (payload *eth.ExecutionPayload, errTyp BlockInsertionErrType, err error) {
	if localOnly {
